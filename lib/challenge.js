 ...
 * You have received an array of objects representing data about the women
 * competing for Kolton's heart.
 *
...
/**
 * Kolton is from California and wants to know how many contestants are
 * from his home state.
 *
 * Return the number of contestants from California.
*/
...
/** Kolton recently read in his horoscope that he is likely to match with an
 * Aries.
 *
 * Return the number of contestants from California who are also an Aries.
 * */
...
/**
 * Help Kolton out! The show has begun, and he needs to start a conversation
 * with the contestants.
 *
 * Return an array where each object will have a new property 'icebreaker',
...
/**
 * Kolton is nervous that an old flame from Michigan has made it onto his
 * season.
 *
 * Return true if at least one contestant is from MI,
 * or false if there will be no contestants from MI.
 */
...
/** Aries is of the most assertive astrological signs. Let's find out which
...
function firstAries (list) {
  ...
  if (ariesContestants.length >= 1) {
    console.log(
      'Hi, my name is ' +
        ariesContestants[0].firstName +
        ' ' +
        ariesContestants[0].lastInitial +
        ' from ' +
        ariesContestants[0].city +
        ', and I was the first to sign up!'
    )
  } else {
...
/**
 * Kolton wants to know the breakdown of each astrological sign.
 *
